...
\usepackage[colorlinks=true,
		    linkcolor=refcyan,
            urlcolor=refcyan,
            citecolor=refcyan]{hyperref}              %Creates hyperlinks in cross references
\usepackage{textcomp}           
\usepackage{url}
...
\usepackage[backend=biber,style=numeric,backref=true,sorting=none,pagetracker=true,backrefstyle=three+,citecounter=true]{biblatex}
\addbibresource{bibliography/references.bib}

% Force biblatex to show backreferences in the numeric style 
\renewbibmacro*{finentry}{%
  \iffieldundef{pageref}
    {}
    {\space\printtext[parens]{\printfield{pageref}}}%
  \finentry} 
